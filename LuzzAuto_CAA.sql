...
(4, 'LUM - Lusso Unico Motori', 'EremiNator', 'Usato', 260000, 2016, 1900, 'Rosso', 'Benzina', 'Manuale', 'Integrale', 1700, 4850, 0, 2, 'ereminator-1.webp+ereminator-2.webp+ereminator-interni.webp', 'Monster truck rosso, decalcomanie di fiamme verdi, salta sul terreno incidentato, fari LED+\n    Monster truck rosso con fiamme verdi, ampio cassone+\n    Sedili in pelle neri con cuciture rosse, roll cage, plancia da competizione'),
(5, 'LUM - Lusso Unico Motori', 'Due Cavalli', 'Usato', 15000, 2024, 12000, 'Verde', 'Metano', 'Manuale', 'Anteriore', 2, 500, 1, 4, 'due-cavalli.webp', 'Carrozza tradizionale, colore verde scuro con ruote rosse, sedili neri'),
(6, 'LUM - Lusso Unico Motori', 'Nove Renne', 'Usato', 0, 1823, 1320000000, 'Rosso', 'Metano', 'Manuale', 'Anteriore', 1000000, 800, 0, 1, 'nove-renne.webp', 'Slitta vintage rossa in legno con lati curvilinei, sedile in pelle imbottita, pattini metallici'),
